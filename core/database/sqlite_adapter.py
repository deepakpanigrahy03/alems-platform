...
from .schema import (CREATE_SANDBOX_IDENTITY, CREATE_CPU_SAMPLES, CREATE_ENERGY_SAMPLES, CREATE_RUN_QUALITY,
                     ...
                     CREATE_NIC_SAMPLES,
                     CREATE_EXTENSION_REGISTRY, CREATE_WRITER_IDEMPOTENCY,
...
class SQLiteAdapter(DatabaseInterface):
    ...
    def create_tables(self) -> None:
        ...
        self.conn.executescript(CREATE_FAILURE_INJECTION_LOG)
        self.conn.executescript(CREATE_FAILURE_COST_PROFILE)
