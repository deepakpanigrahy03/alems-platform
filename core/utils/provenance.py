...
COLUMN_PROVENANCE: Dict[str, Tuple[Optional[str], str]] = {
    ...
    "ge.orchestration_fraction": ("goal_orchestration_fraction_v2",   "CALCULATED"),
    ...
    "l1d_cache_misses_total":       ("arm_pmu_v1",                     "MEASURED"),
    "l2_cache_misses_total":        ("arm_pmu_v1",                     "MEASURED"),
    "l3_cache_hits_total":          ("arm_pmu_v1",                     "MEASURED"),
    "l3_cache_misses_total":        ("arm_pmu_v1",                     "MEASURED"),
    ...
    "cpu_active_ratio":             ("cpu_active_ratio_v1",             "MEASURED"),
    ...
    "planning_energy_uj":        ("phase_attribution_sample_v2",  "MEASURED"),
    "execution_energy_uj":       ("phase_attribution_sample_v2",  "MEASURED"),
    "synthesis_energy_uj":       ("phase_attribution_sample_v2",  "MEASURED"),
    "inter_phase_energy_uj":     ("phase_attribution_sample_v2",  "CALCULATED"),
    "phase_sample_coverage_pct": ("phase_attribution_sample_v2",  "CALCULATED"),  
    ...
    "ea.decode_energy_uj":               ("llm_energy_sample_v2",       "MEASURED"),
...
METHOD_CONFIDENCE: Dict[str, float] = {
    ...
    "phase_attribution_sample_v2":       0.98,
    "llm_energy_sample_v2":              0.97,
    "goal_orchestration_fraction_v2":    1.0,
