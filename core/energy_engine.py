...
# Platform adapter registry (35C) is used by verify_hardware.py and install.sh.
# energy_engine uses get_platform_capabilities() from core.utils.platform directly.
